...
const dir = {
  ...
  chainNodeDefAggregate: 'chainNodeDefAggregate',
  files: 'files',
  records: 'records',
...
export const ExportFile = {
  ...
  chainNodeDef: FileUtils.join(dir.chains, 'chainNodeDefs.json'),
  chainNodeDefAggregate: FileUtils.join(dir.chains, 'chainNodeDefAggregates.json'),
