...
export default class ChainsSamplingNodeDefsCheckJob extends Job {
  constructor(params) {
    super(ChainsSamplingNodeDefsCheckJob.type, params)
  }
...
ChainsSamplingNodeDefsCheckJob.type = 'ChainsSamplingNodeDefsCheckJob'
