...
const getRowValues = async (survey, nodeDef, record, nodeRow, nodeDefColumns, client) => {
  const rowValues = await DataRow.getValues(Survey.getSurveyInfo(survey), nodeDef, record, nodeRow, nodeDefColumns, client)
  return [
