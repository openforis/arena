...
const getRowValues = async (survey, nodeDef, record, nodeRow, nodeDefColumns, surveyIndex) => {
  const rowValues = await DataRow.getValues(Survey.getSurveyInfo(survey), nodeDef, record, nodeRow, nodeDefColumns, surveyIndex)
  return [
