...
const Attributes = () => {
  ...
  return (
    <div className="chain-node-defs-attributes">
      <div className="chain-node-defs-attributes__header">
        <div className="chain-node-defs-attributes__header-label">{nodeDefLabel}</div>

        <div className="chain-node-defs-attributes__header-buttons">
          <div>
