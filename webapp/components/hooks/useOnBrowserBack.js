 ...
 * @param {!Function} [params.onBack] - Callback to be called when back button is pressed. It should return true when navigate.go(-1) is called by the callback itself, false othwerwise.
