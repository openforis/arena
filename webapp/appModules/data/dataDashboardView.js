...
class DataDashboardView extends React.Component {
  ...
  render () {
    ...
    return (
      <DataFetchComponent module={appModules.data} dashboard={true}>
...
DataDashboardView.defaultProps = {
  survey: {},
  dataExplorer: {
    surveyId: -1,
    entities: {},
...
export default withRouter(
  connect(mapStateToProps, {createRecord})(DataDashboardView)
)