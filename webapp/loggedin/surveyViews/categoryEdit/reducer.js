...
const actionHandlers = {
  ...
  [categoryItemCreate]: (state, { level, item }) =>
    CategoryEditState.createLevelItem(CategoryLevel.getIndex(level), item)(state),

  [categoryItemUpdate]: (state, { level, item }) =>
    CategoryEditState.assocLevelItem(CategoryLevel.getIndex(level), item)(state),
  ...
  [categoryItemDelete]: (state, { level, item }) =>
    CategoryEditState.dissocLevelItem(CategoryLevel.getIndex(level), CategoryItem.getUuid(item))(state),
  ...
  [categoryEditImportSummaryColumnDataTypeUpdate]: (state, { columnName, dataType }) =>
    CategoryEditState.assocImportSummaryColumnDataType(columnName, dataType)(state),
}
