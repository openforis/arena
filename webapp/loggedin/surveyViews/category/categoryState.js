...
export const assocLevelActiveItem = (levelIndex, itemUuid) =>
  R.pipe(resetNextLevels(levelIndex, keys.levelItems), resetNextLevels(levelIndex, keys.levelActiveItems), (state) =>
    itemUuid
      ? R.assocPath([keys.levelActiveItems, String(levelIndex)], itemUuid, state)
...
export const assocLevelItem = (levelIndex, item) =>
  R.assocPath([keys.levelItems, String(levelIndex), CategoryItem.getUuid(item)], item)

export const assocLevelItemProp = (levelIndex, item, key, value) =>
  R.assocPath([keys.levelItems, String(levelIndex), CategoryItem.getUuid(item), CategoryItem.keys.props, key], value)
