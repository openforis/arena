...
const _initList = (module, moduleApiUri, restParams, offset) => async (
  dispatch,
  getState,
) => {
...
export const initListItems = (module, moduleApiUri, restParams) => async (
  dispatch,
  getState,
) => {
  const state = getState()
...
export const reloadListItems = (module, restParams) => async (
  dispatch,
  getState,
) => {
  const state = getState()
