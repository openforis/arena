...
export default defineConfig([
  {
    ...
    // Defines the environments in which the code will run.
    // This automatically sets global variables for those environments.
    env: {
      browser: true,
      commonjs: true,
      es6: true,
    ...
    // Defines global variables that are available throughout your code.
    // "readonly" means the variable can't be reassigned.
    globals: {
      step: 'readonly',
    },
