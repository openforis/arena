...
export const verifyNodeDefs = (survey) => {
  test(`Verify ${survey.name} nodeDefs`, async () => {
    ...
    const clusterExportChildDefs = getNodeDefChildren({ nodeDef: clusterExport })(surveyExport)
    ...
    const plotExportChildDefs = getNodeDefChildren({ nodeDef: plotExport })(surveyExport)
    ...
    const treeExportChildDefs = getNodeDefChildren({ nodeDef: treeExport })(surveyExport)
