...
const tests = [
  ...
  },
  {
    ...
    expected: String.raw`{"a":{"__type":"Map","__values":"[[1,\"one\"],[2,\"two\"],[3,\"three\"]]"}}`,
  },

  {
    ...
    expected: String.raw`{"a":1,"b":"b","c":{"__type":"Map","__values":"[[1,\"one\"],[\"2\",\"two\"],[3,\"three\"]]"},"d":{"__type":"Set","__values":"[1,2,3]"}}`,
  },
  {
    value: {
      a: 1,
    ...
    expected: String.raw`{"a":1,"b":"b","n":{"b":"aaaa","aa":{"c":"aaa","map":{"__type":"Map","__values":"[[\"mapk\",\"map\"],[\"1\",\"map\"]]"}}},"c":{"__type":"Map","__values":"[[1,\"one\"],[\"2\",\"two\"],[3,{\"__type\":\"Map\",\"__values\":\"[[5,\\\"five\\\"]]\"}]]"},"d":{"__type":"Set","__values":"[1,2,3]"}}`,
  },
...
describe('A.stringify', () => {
  tests.forEach(({ value, valueText, expected }) => {
    it(`${valueText} ->  ${expected}`, () => {
      ...
      expect(String(expected)).toEqual(String(result))
      if (!A.isEmpty(result)) {
        expect(value).toEqual(A.parse(result))
      }
    })
  })
})
