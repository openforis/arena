...
const getChildrenCountValidation = key => (parentNode, childDef) =>
  R.pipe(
...
export const getValidationMinCount = getChildrenCountValidation(
  RecordValidation.keys.minCount,
)

export const getValidationMaxCount = getChildrenCountValidation(
