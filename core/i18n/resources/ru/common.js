...
`,
  ...
  nodeDefEdit: {
    ...
    functionDescriptions: {
      ...
      prevCycleValue:
        'Возвращает значение того же атрибута в записи предыдущего цикла (работает только в Arena Mobile, если определены несколько циклов и когда включена ссылка на предыдущий цикл)',
      prevCycleValues:
        'Возвращает значения одинаковых атрибутов в записи предыдущих циклов (работает только в Arena Mobile, если определены несколько циклов и когда включена ссылка на предыдущий цикл)',
