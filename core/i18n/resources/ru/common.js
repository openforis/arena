...
`,
  ...
  nodeDefEdit: {
    ...
    advancedProps: {
      defaultValuesRadioNone: 'Значения по умолчанию не указаны',
      defaultValuesRadioDefined: 'Значения по умолчанию указаны',
      editableIfRadioNone: 'Всегда редактируемо',
      editableIfRadioDefined: 'Редактируемо при выполнении условия',
      relevantIfRadioNone: 'Всегда актуально',
      relevantIfRadioDefined: 'Актуально при выполнении условия',
      visibleIfRadioNone: 'Всегда видимо',
      visibleIfRadioDefined: 'Видимо при выполнении условия',
