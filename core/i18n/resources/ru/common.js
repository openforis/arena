...
`,
  ...
  nodeDefEdit: {
    ...
    basicProps: {
      ...
      qualifier: {
        label: 'Квалификатор',
        info: `Когда пользователь, принадлежащий к группе, создаёт новую запись, этот атрибут будет автоматически заполнен значением, указанным для него в квалификаторах группы пользователя. Пользователи смогут видеть и изменять только записи, принадлежащие их собственной группе, если они входят в какую-либо группу (пока не реализовано).`,
      },
      table: 'Таблица',
    },
    advancedProps: {
