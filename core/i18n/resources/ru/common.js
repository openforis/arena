...
`,
  ...
  nodeDefEdit: {
    ...
    advancedSections: {
      fieldBehavior: {
        title: 'Поведение поля в форме',
        description:
          'Укажите, могут ли респонденты редактировать значения и нужно ли скрывать поле в форме ввода данных.',
      },
      defaultValue: {
        title: 'Значение по умолчанию',
        description:
          'Задайте выражения или константы, используемые при создании новой записи. При необходимости вычисляйте значение по умолчанию только один раз.',
      },
      whenApplies: {
      ...
      answerLists: {
        title: 'Списки ответов',
        description:
          'Для атрибутов «код» и «таксон» при необходимости отфильтруйте доступные для выбора элементы выражением (см. справку поля по синтаксису).',
      },
      reporting: {
        title: 'Отчёты и панели',
        description:
          'Управляйте видимостью атрибута в аналитической панели, когда включена экспериментальная опция.',
      },
    },
    advancedProps: {
