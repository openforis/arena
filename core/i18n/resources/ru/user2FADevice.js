...
Пожалуйста, сохраните следующие 8 резервных кодов в безопасном месте:  
**{{backupCodes}}**  
Их можно использовать для доступа к аккаунту, если вы потеряете доступ к устройству-аутентификатору.
Каждый резервный код можно использовать только один раз. После использования резервный код станет недействительным.
Резервные коды можно увидеть только при создании устройства, поэтому обязательно сохраните их сейчас.`,
  },
  deletion: {
