...
Veuillez également vérifier le dossier Spam/Courrier indésirable.`,
    ...
    goToSurveys: 'Aller aux formulaires',
    group: 'Groupe',
    help: 'Aide',
    hide: 'Masquer',
    id: 'id',
...
Pour publier sans mettre à jour les données existantes, cochez « Ignorer la mise à jour des données » ci-dessous (non recommandé).`,
    ...
    reset: 'Réinitialiser',
    refresh: 'Actualiser',
    pressRefreshToReloadPage: 'Appuyez sur Actualiser pour recharger la page.',
    resume: 'Reprendre',
    retry: 'Réessayer',
    role: 'Rôle',
    save: 'Sauvegarder',
...
(il doit s'agir d'un attribut de type code ou texte ; sa valeur est comparée aux propriétés supplémentaires définies pour la catégorie de 1ère phase - le nom de l'attribut n'a pas besoin de correspondre à celui de la propriété supplémentaire)`,
    ...
    firstPhaseSamplingPointDataJoinMethod: {
      ...
      description:
        "L'unité de base et la table de 1ère phase sont jointes à l'aide de la méthode Données de points d'échantillonnage : l'attribut clé de l'unité de base et la catégorie de 1ère phase utilisent tous deux la catégorie Données de points d'échantillonnage, aucun attribut de jointure distinct n'est donc nécessaire.",
    },
...
`,
  ...
  expression: {
    ...
    invalidTaxonomyExtraProp: 'Nom de propriété supplémentaire de taxonomie invalide : {{propName}}',
