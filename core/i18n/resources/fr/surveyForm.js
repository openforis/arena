...
Continuer ?`,
  ...
  schemaSummaryAiDescriptions_csv: 'Résumé du schéma + descriptions IA (CSV)',
  schemaSummaryAiDescriptions_xlsx: 'Résumé du schéma + descriptions IA (Excel)',
...
- **Désactivé** : tous les noms vernaculaires d'un taxon sont regroupés et affichés avec le taxon (combinés dans une seule entrée). En conséquence, la liste de saisie automatique contient moins d'éléments.`,
  ...
  cloneFromAnotherSurvey: {
    title: 'Cloner un nœud depuis un autre formulaire',
    expandToLoadNodes: 'Développer pour charger les nœuds',
    loadingSurveyNodes: 'Chargement des nœuds du formulaire...',
    errorLoadingSurveyNodes: 'Erreur lors du chargement des nœuds du formulaire',
    noNodesAvailable: 'Aucun nœud disponible',
    loadingSurveys: 'Chargement des formulaires...',
    noSurveysAvailable: 'Aucun formulaire disponible',
    sourceNode: 'Nœud source',
    targetEntityCurrentSurvey: 'Entité cible (formulaire actuel)',
  },
