...
Continuar?`,
  ...
  schemaSummaryAiDescriptions_csv: 'Resumo do esquema + descrições IA (CSV)',
  schemaSummaryAiDescriptions_xlsx: 'Resumo do esquema + descrições IA (Excel)',
...
- **Desativado**: todos os nomes vernaculares de um táxon são agrupados e exibidos junto ao táxon (combinados em uma única entrada). Como resultado, a lista de autocompletar contém menos itens.`,
  ...
  cloneFromAnotherSurvey: {
    title: 'Clonar nó de outro formulário',
    expandToLoadNodes: 'Expandir para carregar nós',
    loadingSurveyNodes: 'Carregando nós do formulário...',
    errorLoadingSurveyNodes: 'Erro ao carregar nós do formulário',
    noNodesAvailable: 'Nenhum nó disponível',
    loadingSurveys: 'Carregando formulários...',
    noSurveysAvailable: 'Nenhum formulário disponível',
    sourceNode: 'Nó de origem',
    targetEntityCurrentSurvey: 'Entidade de destino (formulário atual)',
  },
