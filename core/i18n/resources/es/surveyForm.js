...
- **Desactivado**: todos los nombres vernáculos de un taxón se agrupan y se muestran junto al taxón (combinados en una sola entrada). Como resultado, la lista de autocompletado contiene menos elementos.`,
  ...
  cloneFromAnotherSurvey: {
    title: 'Clonar nodo desde otro formulario',
    expandToLoadNodes: 'Expandir para cargar nodos',
    loadingSurveyNodes: 'Cargando nodos del formulario...',
    errorLoadingSurveyNodes: 'Error al cargar los nodos del formulario',
  ...
  printableExport: {
    ...
    includeQrCodeInfo:
      'Añade un código QR en la primera página que enlaza a una copia de solo lectura del PDF de esta entidad (válido 1 año).',
