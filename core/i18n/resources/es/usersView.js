...
$t(common.pressRefreshToReloadPage)`,
  userGroup: {
    ...
    name: 'Nombre',
    label: 'Etiqueta',
    qualifier: 'Calificador {{index}}',
    qualifier_plural: 'Calificadores',
    qualifierKey: 'Clave',
    qualifierValue: 'Valor',
    addQualifier: 'Añadir calificador',
    members: 'Miembros',
    ...
    status: {
      INVITED: 'Invitado',
      ACCEPTED: 'Aceptado',
      FORCE_CHANGE_PASSWORD: 'Cambio de contraseña requerido',
    },
    unassigned: 'Sin asignar',
    confirmDelete: '¿Eliminar el grupo "{{name}}"? Sus miembros quedarán sin asignar. ¿Continuar?',
    deleteConfirmed: 'El grupo "{{name}}" ha sido eliminado',
    saveConfirmed: 'El grupo "{{name}}" ha sido guardado',
    confirmReassign: '{{userName}} está actualmente en el grupo "{{groupName}}". ¿Moverlo a este grupo en su lugar?',
