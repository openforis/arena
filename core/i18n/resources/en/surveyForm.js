...
- **Disabled**: all vernacular names for a taxon are grouped together and displayed alongside the taxon (combined in a single entry). As a result, the autocomplete list contains fewer items.`,
  ...
  cloneFromAnotherSurvey: {
    title: 'Clone Node From Another Survey',
    expandToLoadNodes: 'Expand to load nodes',
    loadingSurveyNodes: 'Loading survey nodes...',
    errorLoadingSurveyNodes: 'Error loading survey nodes',
