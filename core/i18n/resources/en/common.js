...
This can permanently change or clear data already entered. Type the survey name below to confirm.`,
    ...
    reset: 'Reset',
    refresh: 'Refresh',
    pressRefreshToReloadPage: 'Press Refresh to reload the page.',
    resume: 'Resume',
    retry: 'Retry',
    role: 'Role',
    save: 'Save',
...
(it must be a code or text attribute with the same name of an extra property defined for the 1st phase category)`,
    },
...
`,
  ...
  expression: {
    ...
    invalidTaxonomyExtraProp: 'Invalid taxonomy extra property name: {{propName}}',
